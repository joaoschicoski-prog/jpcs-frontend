  ...
  return (
    <div style={{ paddingBottom: 80 }}>
      <div style={{ background: "var(--green-600)", padding: "30px 16px 48px", textAlign: "center" }}>
        ...
        {isAdmin && (
          <span style={{ display: "inline-block", marginTop: 8, background: "var(--amber-400)", color: "var(--white)", borderRadius: "var(--radius-full)", padding: "3px 12px", fontSize: 11, fontWeight: 700 }}>ADMIN</span>
        )}
      </div>
