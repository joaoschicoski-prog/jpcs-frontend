...
export function ListProvider({ children }) {
  ...
  const toggleAllChecked = (ids, checked) => saveList(list.map((i) => ids.includes(i.id) ? { ...i, checked } : i));
  ...
  return (
    <ListContext.Provider value={{ list, manualItems, addToList, removeFromList, removeCheckedFromList, toggleChecked, toggleAllChecked, updateQuantity, isInList, addManualItem, removeManualItem, toggleManualChecked, updateManualQuantity, clearAll }}>
      {children}
