        ...
        <div style={{
          ...
          <div>
            <p style={{
              ...
              fontSize: 17, color: "var(--gray-900)",
            }}>
              {product.name}
            </p>
            <p style={{ fontSize: 12, color: "var(--gray-500)", marginTop: 2 }}>
              Comparando preços em {offers.length} mercado{offers.length !== 1 ? "s" : ""}
            </p>
          </div>
          <button
            onClick={onClose}
          ...
          >
            <svg width="16" height="16" fill="none" stroke="var(--gray-600)" strokeWidth="2.5" strokeLinecap="round">
            ...
            <div style={{ padding: "32px 0", textAlign: "center" }}>
              {[1, 2, 3].map((i) => (
                <div key={i} style={{
                  ...
                  background: "var(--gray-100)", marginBottom: 10,
            ...
            offers.map((offer, idx) => {
              ...
              return (
                <div key={offer.id} style={{
                  ...
                  marginBottom: 8,
                  background: isLowest ? "var(--green-50)" : "var(--gray-50)",
                  border: `1px solid ${isLowest ? "var(--green-200)" : "var(--gray-200)"}`,
                  animation: `fadeUp 0.25s ease both`,
                  animationDelay: `${idx * 0.05}s`,
                }}>
                  <div style={{ flex: 1 }}>
                    <div style={{ display: "flex", alignItems: "center", gap: 8, flexWrap: "wrap" }}>
                      {/* Botão do supermercado — visual claro de botão */}
                      <button
                        onClick={() => { onClose(); goToMarket({ name: offer.supermarket, city: offer.city }); }}
                        style={{
                    ...
                    {/* Badge melhor preço — abaixo do botão, menor e discreto */}
                    {isLowest && (
                  ...
                  <p style={{
                    ...
                    fontSize: 20,
                    color: isLowest ? "var(--green-600)" : "var(--gray-700)",
                  }}>
