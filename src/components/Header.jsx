...
export default function Header({ page, setPage }) {
  ...
  return (
    <header style={{
      ...
      >
        <span style={{
          background: "var(--green-400)", borderRadius: "var(--radius-sm)",
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 4 }}>
          ...
          >
            ...
            {list.length > 0 && (
              <span style={{
                ...
                borderRadius: "var(--radius-full)", width: 16, height: 16,
        ...
        <button
          onClick={() => setPage(isLogged ? "profile" : "login")}
          style={{
            width: 40, height: 40, borderRadius: "var(--radius-full)",
            display: "flex", alignItems: "center", justifyContent: "center",
            background: (page === "profile" || page === "login") ? "rgba(255,255,255,0.2)" : "transparent",
          }}
          aria-label={isLogged ? "Perfil" : "Entrar"}
        >
          {isLogged ? (
            <div style={{
              width: 28, height: 28, borderRadius: "var(--radius-full)",
              background: "var(--green-400)", display: "flex",
